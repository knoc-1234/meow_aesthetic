    ...
    >
      ...
      >
        ...
        <div className="flex flex-col items-center text-center">
          <h2
            id={titleId}
            className="max-w-lg font-[--font-playfair] text-4xl leading-tight text-neutral-950 sm:text-5xl"
          >
            {modalTitle}
          </h2>
          ...
          <div className="mt-8 flex w-full flex-col items-center justify-center gap-4 sm:flex-row">
            <a
              ...
              className="flex min-h-16 w-full max-w-[220px] items-center justify-center gap-3 rounded-full bg-black px-5 text-left text-white transition hover:bg-neutral-800"
            >
