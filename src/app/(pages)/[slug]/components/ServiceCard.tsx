    ...
    <div className="flex flex-col gap-5 w-full min-h-full max-w-[250px]">
      ...
      <div className="flex items-center gap-2">
        <a
          ...
          className="text-white hover:text-black hover:border-black border bg-gradient-to-t from-[#A3A3A3] to-[#C7C7C7] hover:from-white hover:to-white px-6 py-1 w-fit transition-all duration-300 inline-flex items-center gap-2"
        >
