      ...
      <div className="flex flex-col gap-5 w-[95%] mx-auto py-5 *:flex *:flex-col *:gap-2">
        <div>
          ...
          <p>
            ...
            have engagedto collect, use, disclose or process personal data for
            our purposes.{" "}
          </p>
        </div>
        ...
        <div>
          ...
          <ul className="list-disc list-inside">
            <li>
              ...
              services we provide, or (b) may, or has, enteredintoacontract with
              us for the supply of any goods or services by us; and
            </li>
            <li>
              <strong>personal data</strong> means data, whether true or not,
              about a customer whocanbeidentified: (a) from that data; or (b)
              from that data and other information to whichwehave or are likely
              to have access.
            </li>
          </ul>
        </div>
        ...
        <div>
          <h2 className="text-lg font-semibold">
            ...
            gender, date of birth, marital status, photographandvideos during
            sessions.
          </h2>
        </div>
        ...
        <div>
          <h2 className="text-lg font-semibold">
            ...
            and use of personal data without consent is permitted or
            requiredbythePDPA or other laws. We shall seek your consent before
            collecting any additional personal data and before using your
            personal data for a purpose which has not beennotified to you
        ...
        <div>
          ...
          <ul className="list-disc list-inside">
            ...
            <li>
              ...
              and investigations conductedbyanygovernmental and/or regulatory
              authority;
            </li>
            <li>
            ...
            <li>
              ...
              party serviceproviders and agents, and relevant governmental
        ...
        <div>
          <h2 className="text-lg font-semibold">
            ...
            a reasonable period thereafter (including, whereapplicable, a period
        ...
        <div>
          ...
          <h2 className="text-lg font-semibold">
            ...
            legitimate interests exceptionof thePDPA, MEOWCADEMY PRIVATE LIMITED
            will assess the likely adverse effectsonthe individual and determine
            that the legitimate interests outweigh any adverseeffect.
          </h2>
        </div>
        ...
        <div>
          ...
          <ul className="list-disc list-inside">
            ...
            <li>
              Network analysis to prevent fraud and financial crime, and
              performcredit analysis; and
            </li>
            <li>
              Collection and use of personal data on company-issued devices to
              prevent dataloss.
            </li>
          </ul>
          <p>
            The purposes listed in the above clause may continue to apply even
            in situations whereyour relationship with us (for example, pursuant
            to a contract) has been terminated or alteredinany way, for a
        ...
        <div>
          ...
          <h2 className="text-lg font-semibold">
            ...
            request us to stop collecting, using and/or disclosingyour personal
            data for any or all of the purposes listed above by submitting your
          ...
          <h2 className="text-lg font-semibold">
            ...
            to be processed and for us to notify youof theconsequences of us
            acceding to the same, including any legal consequences which may
            affect your rights and liabilities to us. In general, we shall seek
          ...
          <h2 className="text-lg font-semibold">
            ...
            completing the processing of your request. Should you decidetocancel
          ...
          <h2 className="text-lg font-semibold">
            ...
            which we hold about you, you may submit your request in writingor
          ...
          <h2 className="text-lg font-semibold">
            ...
            days after receiving your request, wewill inform you in writing
            within thirty (30) days of the time by which we will beabletorespond
            to your request. If we are unable to provide you with any personal
            dataor tomake a correction requested by you, we shall generally
          ...
          <h2 className="text-lg font-semibold">
            ...
            physical and technical measures such as minimisedcollection of
            personal data, authentication and access controls (such
            asgoodpassword practices, need-to-basis for data disclosure, etc.),
            encryption of data, dataanonymisation, up-to-date antivirus
            protection, regular patching of operatingsystemand other software,
            securely erase storage media in devices before disposal, websecurity
            measures against risks, usage of one time password(otp)/2factor
            authentication (2fa)/multi-factor authentication (mfa) to secure
          ...
          <h2 className="text-lg font-semibold">
            ...
            changes to your personal data by informingour Data Protection
