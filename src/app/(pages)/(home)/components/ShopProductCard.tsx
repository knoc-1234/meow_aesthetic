        ...
        {addtoCart && (
          <div className="flex items-center gap-2 my-2">
            <a
              ...
              className="bg-[#76747B] text-white py-2 px-4 text-center hover:bg-[#5a585f] transition-colors inline-flex items-center gap-2"
            >
            ...
            <AppDownloadModalButton
              ...
              className="bg-[#76747B] text-white py-2 px-4 text-center"
            >
              Buy Now
            </AppDownloadModalButton>
          </div>
